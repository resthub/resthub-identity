define([ 'backbone','backbone-queryparams' ], function(Backbone) {
	var AppRouter = Backbone.Router.extend({
		...
		groups : function() {
			require([ 'model/group', 'view/group/groups-view', 'collection/groups' ], function(
					Profile,ProfilesView, Profiles) {
		...
		groupRoles : function() {
			require([ 'model/group', 'view/role/groups-view', 'collection/groups' ], function(
					Group,GroupsView, Groups) {
					window.group = Groups;
		...
		roles : function() {
			require([ 'model/role', 'view/role/roles-view', 'collection/roles' ], function(
					Role,RolesView, Roles) {
					window.role = Role;
