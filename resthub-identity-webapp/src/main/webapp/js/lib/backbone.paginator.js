            ...
            _.each(models, function (model) {
                ...
                _.each(rules, function (rule) {
                    ...
                    if (rule.type === "function") {
                        ...
                        if (!_.isNaN(Number(model.get(rule.field))) && !_.isNaN(Number(rule.value)) &&
                        ...
                        if (!_.isNaN(Number(model.get(rule.field))) &&
                            _.isObject(rule.value) && !_.isNaN(Number(rule.value.min)) && !_.isNaN(Number(rule.value.max)) &&
                        ...
                        if (_.isObject(rule.value) && !_.isNaN(Number(rule.value.min)) && !_.isNaN(Number(rule.value.max)) &&
