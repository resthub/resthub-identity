...
import org.resthub.identity.repository.SearchRepository;
...
public class SearchServiceImpl implements SearchService {
	...
	/**
	 * Repository used to performs searches.
	 */
	@Inject
	...
	public List<AbstractPermissionsOwner> search(String query, boolean withUsers, boolean withGroups) {
		...
		return searchRepository.search(query, withUsers, withGroups);
	} // search().
