 ...
 */
public class UserServiceImpl<T extends User, I extends Serializable, R extends UserRepository<T, I>> extends CrudServiceImpl<T, I, R> implements UserService<T, I>, ApplicationEventPublisherAware {
    ...
    public T update(T user) throws AlreadyExistingEntityException {
        ...
        // different I
        T existingUser = this.findById((I) user.getId());
        if (user.getPassword() == null) {
