...
import org.resthub.identity.core.repository.GenericGroupRepository;
 ...
 **/
public class GenericGroupServiceImpl<T extends Group, TRepository extends GenericGroupRepository<T>> extends CrudServiceImpl<T, Long, TRepository> implements GenericGroupService<T>, ApplicationEventPublisherAware {
	...
	@Override
	public void setRepository(TRepository groupRepository) {
	...
	@Inject
	@Named("roleService")
	protected void setRoleService(GenericRoleService roleService) {
