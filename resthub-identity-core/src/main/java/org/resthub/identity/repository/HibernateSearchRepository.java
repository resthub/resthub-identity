...
/**
 * Implementation of the search Repository with HibernateSearch
 */
@Named("searchRepository")
public class HibernateSearchRepository implements SearchRepository {

	/**
	 * Classe's logger
	 */
	protected final static Logger logger = LoggerFactory.getLogger(HibernateSearchRepository.class);
	...
	public void resetIndexes() {
		...
		try {
			FullTextEntityManager searchFactory = Search.getFullTextEntityManager(entityManagerFactory.createEntityManager());
