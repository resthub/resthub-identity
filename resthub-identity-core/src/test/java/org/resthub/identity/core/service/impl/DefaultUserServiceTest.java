...
import org.resthub.identity.core.service.*;
...
public class DefaultUserServiceTest extends AbstractTransactionalTest {
    ...
    @Inject
    @Named("groupService")
    private GroupService<Group, Long> groupService;
    ...
    private ApplicationService<Application, Long> applicationService;

    @Inject
    @Named("permissionService")
    private PermissionService<Permission, Long> permissionService;
    ...
    public void testDirectPermissions() {
        ...
        Permission admin = this.permissionService.create(new Permission("ADMIN"));
        Permission user = this.permissionService.create(new Permission("USER"));
    ...
    public void testGroupsPermissions() {
        ...
        Permission admin = this.permissionService.create(new Permission("ADMIN"));
        Permission user = this.permissionService.create(new Permission("USER"));
        Permission testgroup = this.permissionService.create(new Permission("TESTGROUPPERMISSION"));
        Permission testsubgroup = this.permissionService.create(new Permission("TESTSUBGROUPPERMISSION"));
    ...
    public void testDirectPermissionsFilteredByApplication() {
        ...
        Permission admin = this.permissionService.create(new Permission("ADMIN", app1));
        Permission user = this.permissionService.create(new Permission("USER", app2));
